...
//This is pure shit don't look at it
...
namespace engine::vulkan
{
	...
	void InitVulkan()
	{
		...
		CreateGraphicsPipeline(); // TODO: move to shader.h
		CreateCommandPool();
		CreateDepthResources();
		CreateFramebuffers();
	}
	...
	void DrawFrame()
	{
		...
		vulkan::UpdateUniformBuffer(vulkan::currentFrame);

		vkResetFences(vulkan::device, 1, &vulkan::inFlightFences[vulkan::currentFrame]);

		vkResetCommandBuffer(vulkan::commandBuffers[vulkan::currentFrame], /*VkCommandBufferResetFlagBits*/ 0);
