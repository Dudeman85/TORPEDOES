...
void CreateShell(engine::ecs::Entity entity)
{
	...
	Audio* audio = engine::AddAudio("Gameplay", "audio/bang_09.wav", false, 1000);
	engine::ecs::AddComponent(shell, engine::SoundComponent{ .Sounds = {{"Shoot" + to_string(player.id) ,audio}} });
