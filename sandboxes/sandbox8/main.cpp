...
int main()
{
	...
	*/
	...
	ecs::AddComponent(laMuerte4, ModelRenderer{ .model = &model , .textures = textures });
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		std::string timerStr = std::to_string((int)round(Timer)); // round pyrista float arvo lahipakokonais 
