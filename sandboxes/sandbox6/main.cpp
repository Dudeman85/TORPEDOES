...
int main()
{
	...
	*/
	...
	ecs::AddComponent(laMuerte, Player{ .acerationSpeed = 300.0f, .minAceleration = 120.0f, .playerID = 0, .nameText = pFont1, .playername = playerNames[0], .playerLap = lap });
	...
	ecs::AddComponent(laMuerte2, Player{ .acerationSpeed = 300.0f, .minAceleration = 120.0f, .playerID = 1, .nameText = pFont2,.playername = playerNames[1], .playerLap = lap });
	...
	ecs::AddComponent(laMuerte3, Player{ .acerationSpeed = 300.0f, .minAceleration = 120.0f, .playerID = 2, .nameText = pFont3,.playername = playerNames[2], .playerLap = lap });
	...
	ecs::AddComponent(laMuerte4, Player{ .acerationSpeed = 300.0f, .minAceleration = 120.0f, .playerID = 3, .nameText = pFont4,.playername = playerNames[3], .playerLap = lap });
